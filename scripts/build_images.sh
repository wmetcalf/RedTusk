#!/usr/bin/env bash
# Build and export RedTusk's images. Thin wrapper around `blastbox
...
#      REDTUSK_FC_DIR      where the Firecracker rootfs is written
#      REDTUSK_GVISOR_DIR  where the gVisor tree is written (default
#                          /var/lib/redtusk-gvisor)
set -euo pipefail
