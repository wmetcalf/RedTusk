...
class SchemaValidationError(Exception):
    ...
    (Was in the bespoke-host ``errors.py``, deleted in the blastbox migration;
    inlined here so the recovered schema module is self-contained.)"""
...
_ENTRY_SCHEMA = {
    ...
    "properties": {
        ...
        "thumbnail_skipped": {"type": ["string", "null"],
                              "enum": ["zero_byte_stream", "pass2_missed_entry",
                                       "pass1_buffer_cap", None]},
